...
// indeterminacy equation, see Bianchi and Nicolo (2021)
wBN = (1/alphaBN)*wBN(-1) + eps_s - (pinfobs - expectation(-1)(pinfobs));
...
crpi,1.7985,0.01,5                   ,NORMAL_PDF,1.1,0.5;
...
// My additions
stderr eps_s,    0.10,  0.001,120,        INV_GAMMA_PDF,0.1,2.0;
alphaBN,        1.25,   0.5,1.5,           UNIFORM_PDF, , ,0.5, 1.5;

corr ea, eps_s, 0,   -1,1,             UNIFORM_PDF, , ,-1, 1;
corr eb, eps_s, 0,   -1,1,             UNIFORM_PDF, , ,-1, 1;
corr eg, eps_s, 0,   -1,1,             UNIFORM_PDF, , ,-1, 1;
corr eqs, eps_s, 0,   -1,1,             UNIFORM_PDF, , ,-1, 1;
corr em, eps_s, 0,   -1,1,             UNIFORM_PDF, , ,-1, 1;
corr epinf, eps_s, 0,   -1,1,             UNIFORM_PDF, , ,-1, 1;
corr ew, eps_s, 0,   -1,1,             UNIFORM_PDF, , ,-1, 1;
end;

varobs dy dc dinve labobs pinfobs dw robs;
set_dynare_seed('clock');
estimation(datafile = usdata_sw_mat, nobs = 54, mh_replic=0, nograph, nodiagnostic, mode_compute=0, presample = 4);
//estimation(datafile = simobs, mh_replic=0, nograph, nodiagnostic, mode_compute=0, presample = 4);
