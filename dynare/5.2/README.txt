...
Dynare works on top of MATLAB®, any version ranging from 8.3 (R2014a) to 9.12
(R2022a). Only 64-bit versions are supported.
...
This version of Dynare is compiled for Octave 6.4.0 (MinGW, 64-bit),
