...
%
M_.exo_det_length = 0;
M_.Sigma_e(1, 1) = (0.62)^2;
M_.Sigma_e(2, 2) = (1.25)^2;
M_.Sigma_e(3, 3) = (0.40)^2;
M_.Sigma_e(4, 4) = (0.55)^2;
M_.Sigma_e(5, 5) = (0.15)^2;
M_.Sigma_e(6, 6) = (0.20)^2;
M_.Sigma_e(7, 7) = (0.26)^2;
options_.irf = 0;
...
save([M_.dname filesep 'Output' filesep 'SW_sim_results.mat'], 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'SW_sim_results.mat'], 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'SW_sim_results.mat'], 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'SW_sim_results.mat'], 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'SW_sim_results.mat'], 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'SW_sim_results.mat'], 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'SW_sim_results.mat'], 'oo_recursive_', '-append');
end
