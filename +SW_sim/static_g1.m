...
if T_flag
    T = SW_sim.static_g1_tt(T, y, x, params);
end
g1 = zeros(42, 42);
g1(1,11)=(-params(9));
g1(1,18)=(-(1-params(9)));
...
g1(10,18)=1;
g1(11,15)=(-T(5));
g1(11,35)=(-(params(11)*T(11)*T(5)*(1+T(9))));
g1(11,39)=1-(1-T(5));
g1(12,20)=1;
g1(12,22)=(-params(9));
g1(12,30)=(-(1-params(9)));
...
g1(15,23)=1;
g1(15,40)=(-1);
g1(16,24)=(-(T(10)*1/(params(11)*T(11))));
g1(16,35)=(-1);
...
g1(20,32)=(-params(17));
g1(21,20)=(-(1/(1+T(9)*params(20))*T(14)));
g1(21,29)=1-1/(1+T(9)*params(20))*(T(9)+params(20));
g1(21,37)=(-1);
g1(22,25)=(-(T(16)*T(18)));
g1(22,28)=(-(params(22)*T(16)));
g1(22,29)=(-(T(15)+params(18)/(1+T(9))-(1+T(9)*params(18))/(1+T(9))));
g1(22,30)=1-(T(10)+T(15)-T(16));
g1(22,38)=(-1);
...
g1(32,8)=1;
g1(33,26)=(-T(5));
g1(33,35)=(-(params(11)*T(11)*T(5)*(1+T(9))));
g1(33,40)=1-(1-T(5));
g1(34,4)=1;
g1(35,5)=1;
g1(36,6)=1;
