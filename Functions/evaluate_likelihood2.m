function [llik,ldens,parameters] = evaluate_likelihood(parameters,M_,estim_params_,oo_,options_,bayestopt_)
...
ldens = evaluate_prior2(parameters,M_,estim_params_,oo_,options_,bayestopt_);
llik = llik - ldens;